...
class Calculator:
    def __init__(self,master):
        ...
        self.entry_value=''
        Entry(width=17,bg='#FFD95A',font=('Arial Bold',28),textvariable=self.equation).place(x=0,y=0)
        ...
        Button(width=11,height=4,text='=',relief='flat',bg='#FFD95A',command=self.solve).place(x=270,y=350)
